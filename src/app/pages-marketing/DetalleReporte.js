...
const DetalleReporte = () => {
  ...
  const cargarReporte = () => {
    ...
    setMostrarCargaDatos(true);
      ...
      api
        .get(`detalleReporte/${location.state.idReporte}`)
        .then((res) => res.data)
        .then((data) => {
          console.log(data);
          setIdReporte(parseInt(data["idReporte"]));
          ...
          setFilas(data["filas"]);
          if (data["columnas"] != [] && data["filas"]!=[]) setMostrarTablaElementos(true);
          setMostrarCargaDatos(false);
          setMostrarDatos(true);
        })
        .catch((err) => alert(err));
        ...
        <div>
          <div>
            <div className="page-header">
              <h3 className="page-title"> Detalle de reporte </h3>
            </div>
            <div className="row">
