...
const DetalleCampana = () => {
  ...
  const cargarCampana = () => {
    ...
    setMostrarCargaDatos(true);
      ...
      api
        .get(`detalleCampana/${location.state.idCampana}`)
        .then((res) => res.data)
        .then((data) => {
          console.log(data);
          ...
          if (data["idPlan"] != 0)
            ...
            if (data["idEstrategia"] != 0)
                setEstrategia({
                  id: parseInt(data["idEstrategia"]),
                  descripcion: data["descripcionEstrategia"],
                });
        ...
        <div>
          <div>
            <div className="page-header">
              <h3 className="page-title"> Detalle de campaña </h3>
            </div>
            <div className="row">
