...
const CrearEmpresa = () => {
  ...
  const cargarNombresNoDisponibles = (idCuenta) => {
    api
      .post("nombresNoDisponibles", {
        propietario: idCuenta,
      })
      .then((res) => res.data)
      .then((data) => {
        console.log(data);
        setNombresNoDisponibles(data);
      })
      .catch((err) => alert(err));
  };
  ...
  useEffect(() => {
    ...
    cargarNombresNoDisponibles(usuarioPropiedades["idCuenta"]);
  }, []);
    ...
    <>
      <div>
        <div className="page-header">
          <h3 className="page-title"> Nueva empresa </h3>
        </div>
        <div className="row">
